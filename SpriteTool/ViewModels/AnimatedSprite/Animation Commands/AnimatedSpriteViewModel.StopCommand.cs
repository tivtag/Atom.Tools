// <copyright file="AnimatedSpriteViewModel.StopCommand.cs" company="federrot Software">
//     Copyright (c) federrot Software. All rights reserved.
// </copyright>
// <summary>
//     Defines the Atom.Tools.SpriteTool.AnimatedSpriteViewModel.StopCommand class.
// </summary>
// <author>
//     Paul Ennemoser (Tick)
// </author>
...
namespace Atom.Tools.SpriteTool
{
    ...
    /// <content>
    /// Defines the StopCommand of the AnimatedSpriteViewModel class.
    /// </content>
    public partial class AnimatedSpriteViewModel
    {
        /// <summary>
        /// Defines an ICommand that when executed stops animating
        /// the SpriteAnimation.
        /// </summary>
        private sealed class StopCommand : ViewModelCommand<AnimatedSpriteViewModel, AnimatedSprite>
        {
            /// <summary>
            ...
            /// </param>
            public StopCommand( AnimatedSpriteViewModel viewModel )
                : base( viewModel )
            {
            ...
            public override void Execute( object parameter )
            {
                ...
                this.ViewModel.IsAnimationPlaying = false;
                this.ViewModel.animation.Reset();
            }
        }
    }
}
