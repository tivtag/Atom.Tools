...
namespace Atom.Tools.SpriteTool.Atlas.Packing
{
    ...
    /// <summary>Rectangle packer using an algorithm by Javier Arevalo. All credits go to the relevant people!</summary>
    /// <remarks>
    ///   <para>
    ...
    ///   </para>
    /// </remarks>
    public class ArevaloRectanglePacker : BaseRectanglePacker
    {
        /// <summary>
        /// Initializes a new instance of the ArevaloRectanglePacker class.
        /// </summary>
        /// <param name="packingArea">
        /// The size of the area that can be filled with rectangles.
        /// </param>
        /// <param name="initialRectangleCapacity">
        /// The number of rectangles that can be inserted into the new ArevaloRectanglePacker
        /// before memory has to be re-allocated.
        /// </param>
        public ArevaloRectanglePacker( Point2 packingArea, int initialRectangleCapacity )
            : base( packingArea )
        {
            this.anchors.Add( Point2.Zero );
            this.packedRectangles = new List<Rectangle>( initialRectangleCapacity );
        }
        ...
        public override bool TryPack( int rectangleWidth, int rectangleHeight, out Point2 placement )
        {
            ...
            int anchorIndex = SelectAnchorRecursively(
                rectangleWidth,
                rectangleHeight,
                this.actualPackingAreaWidth,
                this.actualPackingAreaHeight
            );

            // No anchor could be found at which the rectangle did fit in
            if( anchorIndex == -1 )
            {
                placement = Point2.Zero;
                return false;
            }
            ...
            // positions of the new rectangle
            {
                ...
                InsertAnchor( new Point2( placement.X + rectangleWidth, placement.Y ) );
                InsertAnchor( new Point2( placement.X, placement.Y + rectangleHeight ) );
            }
        ...
        private void OptimizePlacement( ref Point2 placement, int rectangleWidth, int rectangleHeight )
        {
        ...
        /// </returns>
        private int SelectAnchorRecursively( 
            int rectangleWidth,
            int rectangleHeight, 
            ...
            int testedPackingAreaHeight )
        {
            ...
            if( canEnlargeHeight && shouldEnlargeHeight )
            {
                ...
                return SelectAnchorRecursively(
            ...
            int testedPackingAreaHeight )
        {
            ...
            {
                potentialLocation.Position = this.anchors[index];
        ...
        /// </remarks>
        private void InsertAnchor( Point2 anchor )
        {
        ...
        /// <summary>
        /// The current width of the packing area.
        /// </summary>
        private int actualPackingAreaWidth = 1;

        /// <summary>
        /// The current height of the packing area.
        /// </summary>
        private int actualPackingAreaHeight = 1;

        /// <summary>
        /// The rectangles contained in the packing area.
        /// </summary>
        private readonly List<Rectangle> packedRectangles;

        /// <summary>
        /// The anchoring points where new rectangles can potentially be placed.
        /// </summary>
        private readonly List<Point2> anchors = new List<Point2>();
        ...
        /// </remarks>
        private sealed class AnchorRankComparer : IComparer<Point2>
        {
            /// <summary>
            ...
            public int Compare( Point2 left, Point2 right )
            {
