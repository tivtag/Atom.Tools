// <copyright file="AnimatedSpriteViewModel.PauseCommand.cs" company="federrot Software">
//     Copyright (c) federrot Software. All rights reserved.
// </copyright>
// <summary>
//     Defines the Atom.Tools.SpriteTool.AnimatedSpriteViewModel.PauseCommand class.
// </summary>
// <author>
//     Paul Ennemoser (Tick)
// </author>
...
namespace Atom.Tools.SpriteTool
{
    ...
    /// <content>
    /// Defines the PauseCommand of the AnimatedSpriteViewModel class.
    /// </content>
    public partial class AnimatedSpriteViewModel
    {
        /// <summary>
        /// Defines an ICommand that when executed pauses animating
        /// of the SpriteAnimation.
        /// </summary>
        private sealed class PauseCommand : ViewModelCommand<AnimatedSpriteViewModel, AnimatedSprite>
        {
            /// <summary>
            ...
            /// </param>
            public PauseCommand( AnimatedSpriteViewModel viewModel )
                : base( viewModel )
            {
